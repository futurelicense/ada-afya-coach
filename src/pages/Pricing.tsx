...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      "Watch live trainer workout sessions",
      "Live session chat & interaction",
  ...
  },
  {
    ...
    features: [
      ...
      "1-on-1 live trainer sessions (unlimited)",
...
const faqs = [
  ...
  { q: "What payment methods do you accept?", a: "We accept all major Nigerian bank cards, USSD, bank transfer, and mobile money via Paystack." },
];
