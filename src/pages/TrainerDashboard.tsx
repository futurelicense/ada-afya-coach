...
import { Users, Calendar, TrendingUp, Clock, Star, Radio } from "lucide-react";
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <Tabs defaultValue="clients" className="space-y-4">
        <TabsList className="bg-muted/50 p-1">
          ...
          <TabsTrigger value="live" className="data-[state=active]:bg-card data-[state=active]:shadow-sm gap-1.5">
        ...
        <TabsContent value="live" className="space-y-4">
          <LiveStreamStudio trainerId="trainer_001" trainerName="Coach Emeka" />
        </TabsContent>
      </Tabs>
    </div>
  );
