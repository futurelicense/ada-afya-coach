    ...
    <SidebarProvider defaultOpen={true}>
      <div className="min-h-screen flex w-full smooth-scroll overflow-x-hidden">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          {/* Top header */}
          <header className="min-h-14 md:min-h-16 border-b border-border/50 glass flex items-center px-3 md:px-6 pt-[env(safe-area-inset-top)] sticky top-0 z-10 transition-smooth">
          ...
          <main
            id="main-content"
            tabIndex={-1}
            className="flex-1 p-3 sm:p-4 md:p-6 bg-background overflow-x-hidden animate-fade-in pb-[calc(6rem+env(safe-area-inset-bottom))] md:pb-8"
          >
            {children}
          </main>
