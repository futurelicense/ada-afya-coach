            ...
            {analysis.strengths.length > 0 && (
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-semibold text-success text-sm">Your Strengths</h4>
                </div>
                <ul className="space-y-1">
                  {analysis.strengths.map((strength, idx) => (
                    <li key={idx} className="text-sm pl-6 relative before:content-['✓'] before:absolute before:left-0 before:text-success">
                      {strength}
                    </li>
                  ))}
                </ul>
            ...
            {analysis.areas_to_improve.length > 0 && (
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-semibold text-secondary text-sm">Areas to Focus</h4>
                </div>
                <ul className="space-y-1">
                  {analysis.areas_to_improve.map((area, idx) => (
                    <li key={idx} className="text-sm pl-6 relative before:content-['→'] before:absolute before:left-0 before:text-secondary">
                      {area}
                    </li>
                  ))}
                </ul>
            ...
            {analysis.recommendations.length > 0 && (
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-semibold text-info text-sm">Ada's Recommendations</h4>
                </div>
                <ul className="space-y-1">
