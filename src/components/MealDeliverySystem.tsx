...
import { ShoppingCart, MapPin, Phone, Loader2, Minus, Plus, Store } from "lucide-react";
  ...
  return (
    <Card className="shadow-glow">
      ...
      <CardContent className="space-y-4">
        {vendors.length === 0 ? (
          <EmptyState icon={Store} title="No vendors yet" description="Vendors will show up here once they publish a listing." compact />
        ) : (
          <>
